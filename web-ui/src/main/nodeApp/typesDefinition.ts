...
namespace _netflix {
    export const NETFLIX_IMAGE = 'testCollection'
    export namespace Netflix {
        export type Field = "_id"|"show_id"|"type"|"title"|"director"|"country"|"date_added"|"release_year"|"rating"|"duration"|"description"|"dec"
        export type Record = {
            _id: string
            show_id: string
            type: string
            ...
            rating: string
            description: string
            dec: Util.Mongo.MDecimal
        }
        export class QueryBuilder extends Util.Constraints.BaseQueryBuilder<Record, Field, QueryBuilder> implements Util.Constraints.QueryBuilder<QueryBuilder> {
            public readonly $addConstraint
            constructor(params: Util.Constraints.QueryParams) {
                super(params, p => new QueryBuilder(p))
                this.$addConstraint = (filter) => this.$new({...this.$params, filters: [...this.$params.filters, filter]})
            }
            _id(id: string, ...ids: string[]): QueryBuilder {
                return Util.Constraints.eqInConstraint<string, string, QueryBuilder>(this, '_id', Util.Types.STRING, [id, ...ids])
            }
            get show_id(): Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder> {
                return new Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder>(this, 'show_id', Util.Types.STRING)
            }
            get type(): Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder> {
                return new Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder>(this, 'type', Util.Types.STRING)
            }
            get title(): Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder> {
                return new Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder>(this, 'title', Util.Types.STRING)
            }
            get director(): Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder> {
                return new Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder>(this, 'director', Util.Types.STRING)
            }
            get country(): Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder> {
                return new Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder>(this, 'country', Util.Types.STRING)
            }
            get rating(): Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder> {
                return new Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder>(this, 'rating', Util.Types.STRING)
            }
            get description(): Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder> {
                return new Util.Constraints.ComparisonConstraintBuilder<string, string, QueryBuilder>(this, 'description', Util.Types.STRING)
            }
            get dec(): Util.Constraints.ComparisonConstraintBuilder<Util.Values.Decimal, Util.Mongo.MDecimal, QueryBuilder> {
                return new Util.Constraints.ComparisonConstraintBuilder<Util.Values.Decimal, Util.Mongo.MDecimal, QueryBuilder>(this, 'dec', Util.Types.DECIMAL)
            }
        }
    }
}
export const Collection = {
    Netflix: new _netflix.Netflix.QueryBuilder({collection: _netflix.NETFLIX_IMAGE, filters: [{"_TYPE":"ARecord_Type"}]})
}
